    ...
    filters: [
      {
        ...
        options: [
          ...
          { value: "kitchen", label: { ru: "Кухонная мебель", ua: "Кухонні меблі", en: "Kitchen furniture" } },
        ],
      },
      {
        key: "condition",
    ...
    filters: [
      {
        ...
        options: [
          ...
          { value: "building_materials", label: { ru: "Стройматериалы", ua: "Будматеріали", en: "Building materials" } },
          { value: "food", label: { ru: "Продукты питания", ua: "Продукти харчування", en: "Food & Drinks" } },
        ],
      },
      {
        key: "condition",
