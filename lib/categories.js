    ...
    filters: [
      {
        ...
        options: [
          ...
          { value: "laptops", label: { ru: "Ноутбуки і ультрабуки", ua: "Ноутбуки та ультрабуки", en: "Laptops & ultrabooks" } },
          ...
          // 5. Фото / видео
          { value: "photo_cameras", label: { ru: "Фотоаппараты та объективы", ua: "Фотоапарати та об'єктиви", en: "Cameras & lenses" } },
          ...
          { value: "wearables", label: { ru: "Смарт-часы та браслеты", ua: "Смарт-годинники та браслети", en: "Smart watches & bands" } },
          { value: "e_readers", label: { ru: "Електронные книги", ua: "Електронні книги", en: "E-book readers" } },
          ...
          { value: "other_electronics", label: { ru: "Інша електроніка", ua: "Інша електроніка", en: "Other electronics" } },
        ],
      },
      {
        key: "brand",
