...
export const CATEGORY_DEFS = [
  ...
  },
  {
    key: "currency",
    icon: "💱",
    ua: "Обмін валют / Крипта",
    ru: "Обмен валют / Крипта",
    en: "Currency exchange / Crypto",
    labelKey: "cat_currency",
    color: "text-emerald-700",
    bg: "bg-emerald-50",
    filters: [
      {
        key: "currency_code",
        label: { ru: "Валюта", ua: "Валюта", en: "Currency" },
        type: "select",
        options: [
            { value: "usd", label: { ru: "USD (Доллар)", ua: "USD (Долар)", en: "USD" } },
            { value: "eur", label: { ru: "EUR (Евро)", ua: "EUR (Євро)", en: "EUR" } },
            { value: "uah", label: { ru: "UAH (Гривна)", ua: "UAH (Гривня)", en: "UAH" } },
            { value: "usdt", label: { ru: "USDT (Tether)", ua: "USDT", en: "USDT" } },
            { value: "btc", label: { ru: "BTC (Bitcoin)", ua: "BTC", en: "BTC" } },
            { value: "eth", label: { ru: "ETH (Ethereum)", ua: "ETH", en: "ETH" } },
            { value: "other", label: { ru: "Другая", ua: "Інша", en: "Other" } },
        ]
      },
      {
        key: "exchange_method",
        label: { ru: "Способ", ua: "Спосіб", en: "Method" },
        type: "select",
        options: [
           { value: "cash", label: { ru: "Наличные", ua: "Готівка", en: "Cash" } },
           { value: "non_cash", label: { ru: "Безнал", ua: "Безготівка", en: "Non-cash" } },
        ]
      },
    ],
  },
