  ...
  return (
    <>
      <button 
        ...
        className="flex items-center justify-center p-2.5 bg-gray-100/80 dark:bg-white/10 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20 active:scale-95 transition-all text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400"
        title={t("report_button")}
      >
